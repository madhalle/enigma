...
# encryption. If the key is not included, generate a random key.
...
# The decrypt method takes a ciphertext String and the
#Key used for encryption as arguments. The decrypt method can
#optionally take a date as the third argument. If no date is given,
